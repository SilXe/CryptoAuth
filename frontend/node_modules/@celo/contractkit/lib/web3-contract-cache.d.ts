...
export declare class Web3ContractCache {
    ...
    getCeloUnreleasedTreasury(): Promise<import("@celo/abis-12/web3/CeloUnreleasedTreasury").CeloUnreleasedTreasury>;
    ...
    getElection(): Promise<import("@celo/abis-12/web3/Election").Election>;
    getEpochManager(): Promise<import("@celo/abis-12/web3/EpochManager").EpochManager>;
    getEpochManagerEnabler(): Promise<import("@celo/abis-12/web3/EpochManagerEnabler").EpochManagerEnabler>;
    ...
    getCeloToken(): Promise<import("@celo/abis-12/web3/GoldToken").GoldToken>;
    getGovernance(): Promise<import("@celo/abis-12/web3/Governance").Governance>;
    getLockedGold(): Promise<import("@celo/abis-12/web3/LockedGold").LockedGold>;
    getLockedCelo(): Promise<import("@celo/abis-12/web3/LockedGold").LockedGold>;
    ...
    getScoreManager(): Promise<import("@celo/abis-12/web3/ScoreManager").ScoreManager>;
    getSortedOracles(): Promise<import("@celo/abis/web3/SortedOracles").SortedOracles>;
    getStableToken(stableToken?: StableToken): Promise<NonNullable<import("@celo/abis/web3/Registry").Registry | import("@celo/abis/web3/Accounts").Accounts | import("@celo/abis/web3/IERC20").IERC20 | import("@celo/abis-12/web3/GoldToken").GoldToken | import("@celo/abis/web3/mento/StableToken").StableToken | import("@celo/abis/web3/Attestations").Attestations | import("@celo/abis/web3/BlockchainParameters").BlockchainParameters | import("@celo/abis-12/web3/CeloUnreleasedTreasury").CeloUnreleasedTreasury | import("@celo/abis/web3/DoubleSigningSlasher").DoubleSigningSlasher | import("@celo/abis/web3/DowntimeSlasher").DowntimeSlasher | import("@celo/abis-12/web3/Election").Election | import("@celo/abis-12/web3/EpochManager").EpochManager | import("@celo/abis-12/web3/EpochManagerEnabler").EpochManagerEnabler | import("@celo/abis/web3/EpochRewards").EpochRewards | import("@celo/abis/web3/Escrow").Escrow | import("@celo/abis/web3/FederatedAttestations").FederatedAttestations | import("@celo/abis-12/web3/FeeCurrencyDirectory").FeeCurrencyDirectory | import("@celo/abis/web3/FeeCurrencyWhitelist").FeeCurrencyWhitelist | import("@celo/abis/web3/Freezer").Freezer | import("@celo/abis/web3/FeeHandler").FeeHandler | import("@celo/abis/web3/MentoFeeHandlerSeller").MentoFeeHandlerSeller | import("@celo/abis/web3/UniswapFeeHandlerSeller").UniswapFeeHandlerSeller | import("@celo/abis/web3/0.8/GasPriceMinimum").GasPriceMinimum | import("@celo/abis-12/web3/Governance").Governance | import("@celo/abis-12/web3/GovernanceSlasher").GovernanceSlasher | import("@celo/abis-12/web3/LockedGold").LockedGold | import("@celo/abis/web3/MultiSig").MultiSig | import("@celo/abis/web3/OdisPayments").OdisPayments | import("@celo/abis/web3/Random").Random | import("@celo/abis/web3/mento/Reserve").Reserve | import("@celo/abis-12/web3/ScoreManager").ScoreManager | import("@celo/abis/web3/SortedOracles").SortedOracles | import("@celo/abis-12/web3/Validators").Validators | undefined>>;
    getValidators(): Promise<import("@celo/abis-12/web3/Validators").Validators>;
    /**
