export const ABI = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'bytes', name: 'url', type: 'bytes' },
        ],
    ...
    {
        constant: false,
        inputs: [{ internalType: 'bytes', name: 'url', type: 'bytes' }],
        name: 'addStorageRoot',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
    ...
    {
        constant: true,
        inputs: [{ internalType: 'address[]', name: 'accountsToQuery', type: 'address[]' }],
...
export function newAccounts(web3, address) {
