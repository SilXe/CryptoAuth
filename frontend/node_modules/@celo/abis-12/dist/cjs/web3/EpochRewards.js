...
exports.newEpochRewards = exports.ABI = void 0;
exports.ABI = [
    {
    ...
    },
    {
        ...
        inputs: [
            { internalType: 'uint256', name: 'max', type: 'uint256' },
            { internalType: 'uint256', name: 'adjustmentFactor', type: 'uint256' },
        ],
    ...
    {
        constant: false,
        inputs: [{ internalType: 'uint256', name: 'targetVotingYield', type: 'uint256' }],
...
function newEpochRewards(web3, address) {
    return new web3.eth.Contract(exports.ABI, address);
}
exports.newEpochRewards = newEpochRewards;
