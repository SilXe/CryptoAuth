...
export interface Election extends Contract {
    clone(): Election;
    methods: {
        allowedToVoteOverMaxNumberOfGroups(arg0: string): CeloTxObject<boolean>;
        cachedVotesByAccount(arg0: string): CeloTxObject<string>;
        ...
        electValidatorAccounts(): CeloTxObject<string[]>;
        ...
        getGroupEpochRewardsBasedOnScore(group: string, totalEpochRewards: number | string, groupScore: number | string): CeloTxObject<string>;
        ...
        updateTotalVotesByAccountForGroup(account: string, group: string): CeloTxObject<void>;
        setAllowedToVoteOverMaxNumberOfGroups(flag: boolean): CeloTxObject<void>;
        ...
        electNValidatorAccounts(minElectableValidators: number | string, maxElectableValidators: number | string): CeloTxObject<string[]>;
    ...
    events: {
        AllowedToVoteOverMaxNumberOfGroups: ContractEvent<{
            account: string;
            flag: boolean;
            0: string;
            1: boolean;
