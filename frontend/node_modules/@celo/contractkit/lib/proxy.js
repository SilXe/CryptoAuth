...
const CeloUnreleasedTreasury_1 = require("@celo/abis-12/web3/CeloUnreleasedTreasury");
const EpochManager_1 = require("@celo/abis-12/web3/EpochManager");
const EpochManagerEnabler_1 = require("@celo/abis-12/web3/EpochManagerEnabler");
const FeeCurrencyDirectory_1 = require("@celo/abis-12/web3/FeeCurrencyDirectory");
const LockedGold_1 = require("@celo/abis-12/web3/LockedGold");
const ScoreManager_1 = require("@celo/abis-12/web3/ScoreManager");
...
exports.TRANSFER_OWNERSHIP_ABI = {
    constant: false,
    inputs: [
        {
            name: 'newOwner',
...
const initializeAbiMap = {
    ...
    CeloUnreleasedTreasuryProxy: findInitializeAbi(CeloUnreleasedTreasury_1.ABI),
    ...
    EpochManagerProxy: findInitializeAbi(EpochManager_1.ABI),
    EpochManagerEnablerProxy: findInitializeAbi(EpochManagerEnabler_1.ABI),
    ...
    FeeCurrencyDirectoryProxy: findInitializeAbi(FeeCurrencyDirectory_1.ABI),
    ...
    ScoreManagerProxy: findInitializeAbi(ScoreManager_1.ABI),
