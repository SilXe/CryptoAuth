...
export interface Governance extends Contract {
    ...
    methods: {
        ...
        hotfixExecutionTimeWindow(): CeloTxObject<string>;
        hotfixes(arg0: string | number[]): CeloTxObject<{
            executed: boolean;
            approved: boolean;
            deprecated_preparedEpoch: string;
        ...
        securityCouncil(): CeloTxObject<string>;
        ...
        setSecurityCouncil(_council: string): CeloTxObject<void>;
        setHotfixExecutionTimeWindow(timeWindow: number | string): CeloTxObject<void>;
        ...
        votePartially(proposalId: number | string, index: number | string, yesVotes: number | string, noVotes: number | string, abstainVotes: number | string): CeloTxObject<boolean>;
        ...
        getHotfixHash(values: (number | string)[], destinations: string[], data: string | number[], dataLengths: (number | string)[], salt: string | number[]): CeloTxObject<string>;
        ...
        removeVotesWhenRevokingDelegatedVotes(account: string, newVotingPower: number | string): CeloTxObject<void>;
        resetHotFixRecord(hash: string | number[]): CeloTxObject<void>;
        ...
        getL1HotfixRecord(hash: string | number[]): CeloTxObject<{
            0: boolean;
            1: boolean;
            2: string;
        }>;
        ...
        getL2HotfixRecord(hash: string | number[]): CeloTxObject<{
            0: boolean;
            1: boolean;
            2: boolean;
            3: string;
        ...
        getAmountOfGoldUsedForVoting(account: string): CeloTxObject<string>;
    };
    events: {
        ...
        ProposalVoteRevokedV2: ContractEvent<{
            proposalId: string;
            account: string;
            yesVotes: string;
            noVotes: string;
