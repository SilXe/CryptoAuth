...
exports.newGovernanceSlasher = exports.ABI = void 0;
exports.ABI = [
    {
    ...
    {
        constant: false,
        inputs: [{ internalType: 'address', name: '_slasherExecuter', type: 'address' }],
    ...
    },
    {
        ...
        inputs: [
            { internalType: 'address', name: 'account', type: 'address' },
            { internalType: 'address[]', name: 'electionLessers', type: 'address[]' },
            {
                internalType: 'address[]',
                name: 'electionGreaters',
                type: 'address[]',
            },
            { internalType: 'uint256[]', name: 'electionIndices', type: 'uint256[]' },
        ],
        name: 'slash',
        outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
        payable: false,
...
function newGovernanceSlasher(web3, address) {
    return new web3.eth.Contract(exports.ABI, address);
}
exports.newGovernanceSlasher = newGovernanceSlasher;
