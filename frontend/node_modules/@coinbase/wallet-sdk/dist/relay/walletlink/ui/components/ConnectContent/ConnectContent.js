...
exports.CoinbaseWalletSteps = exports.ConnectItem = exports.ConnectContent = void 0;
    ...
    return ((0, preact_1.h)("div", { "data-testid": "connect-content", className: (0, clsx_1.default)('-cbwsdk-connect-content', theme) },
        ...
        (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-layout" },
            (0, preact_1.h)("div", { className: "-cbwsdk-connect-content-column-left" },
                (0, preact_1.h)(ConnectItem, { title: wallet.title, description: wallet.description, icon: wallet.icon, theme: theme })),
...
function ConnectItem({ title, description, icon, theme }) {
