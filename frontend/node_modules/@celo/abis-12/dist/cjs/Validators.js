...
exports.validatorsABI = void 0;
exports.validatorsABI = [
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: '_maxGroupSize', internalType: 'uint256', type: 'uint256' },
            {
                ...
                type: 'tuple',
                components: [
                    { name: 'commissionUpdateDelay', internalType: 'uint256', type: 'uint256' },
                    { name: 'downtimeGracePeriod', internalType: 'uint256', type: 'uint256' },
                ],
            },
        ],
        name: 'initialize',
    ...
    },
    {
        ...
        outputs: [{ name: 'group', internalType: 'address', type: 'address' }],
    },
    {
        stateMutability: 'view',
        type: 'function',
