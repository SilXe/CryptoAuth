 ...
 */
export declare class ValidatorsWrapper extends BaseWrapperForGoverning<Validators> {
    /**
     ...
     */
    validatorSignerToAccount(signerAddress: Address): Promise<`0x${string}`>;
    /**
     * Returns the account associated with `signer`.
     ...
     * @return The associated account.
     */
    signerToAccount(signerAddress: Address): Promise<`0x${string}`>;
    /**
    ...
    getValidatorsGroup(address: Address): Promise<Address>;
     ...
     */
    getValidatorRewards(epochNumber: number, useBlockNumber?: boolean): Promise<ValidatorReward[]>;
    /**
