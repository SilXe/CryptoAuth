...
export interface Validators extends Contract {
    ...
    methods: {
        ...
        registerValidatorNoBls(ecdsaPublicKey: string | number[]): CeloTxObject<boolean>;
        ...
        mintStableToEpochManager(amount: number | string): CeloTxObject<void>;
        getValidatorBlsPublicKeyFromSigner(signer: string): CeloTxObject<string>;
        getMembershipHistoryLength(): CeloTxObject<string>;
        ...
        getTopGroupValidatorsAccounts(account: string, n: number | string): CeloTxObject<string[]>;
